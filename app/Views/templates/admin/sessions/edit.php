<?php // app/Views/templates/admin/sessions/edit.php
$old = $old ?? [];
?>
...
<section class="auth-section">
    <div class="auth-container">
        <div class="auth-card auth-card-wide">
            ...
            <?php endif; ?>
            <form class="auth-form" method="POST" action="/admin/sessions/<?= $session['id_course'] ?>/update">
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="time" id="session-start" name="start_time"
                                   value="<?= htmlspecialchars(substr($old['start_time'] ?? '', 0, 5)) ?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="time" id="session-end" name="end_time"
                                   value="<?= htmlspecialchars(substr($old['end_time'] ?? '', 0, 5)) ?>" required>
                        </div>
                    </div>
                </div>
                <div class="form-row">
